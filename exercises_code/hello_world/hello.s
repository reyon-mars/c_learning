	...
	.file	0 "/Users/reyon/c_cpp/c_learning/exercises_code/hello_world" "hello_world.c" md5 0xd4cda95a4da81a36087549e8bc64ae04
	.globl	_main                           ; -- Begin function main
	.p2align	2
_main:                                  ; @main
Lfunc_begin0:
	.loc	0 3 0                           ; hello_world.c:3:0
	.cfi_startproc
; %bb.0:
	sub	sp, sp, #32
	...
	stur	wzr, [x29, #-4]
Ltmp0:
	.loc	0 4 2 prologue_end              ; hello_world.c:4:2
	adrp	x0, l_.str@PAGE
	add	x0, x0, l_.str@PAGEOFF
	bl	_printf
	ldr	w0, [sp, #8]                    ; 4-byte Folded Reload
	.loc	0 5 2 epilogue_begin            ; hello_world.c:5:2
...
Linfo_string:
	...
	.asciz	"hello_world.c"                 ; string offset=47
	.asciz	"/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk" ; string offset=61
	.asciz	"MacOSX.sdk"                    ; string offset=113
	.asciz	"/Users/reyon/c_cpp/c_learning/exercises_code/hello_world" ; string offset=124
...
.set Lset10, Lcu_begin0-Lsection_info   ; Compilation unit 0
	...
	.long	211                             ; String in Bucket 0: int
	.long	206                             ; String in Bucket 2: main
	.long	186                             ; String in Bucket 3: __ARRAY_SIZE_TYPE__
	.long	181                             ; String in Bucket 3: char
